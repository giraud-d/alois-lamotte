...
<Main>
	<div class="flex flex-col items-center gap-4 p-4 sm:flex-row md:gap-x-8 md:p-8 lg:items-start">
		...
		<section class="basis-full sm:basis-1/2 lg:basis-3/5 2xl:basis-2/3">
			...
			<p class="pt-2">
				Je suis architecte DE, designer, et artiste française basée en Bretagne dans le Morbihan. Mon travail pluridisciplinaire vise à améliorer le quotidien à
				travers l'architecture, le design, et l'art. Mes œuvres sont inspirées par des souvenirs altérés et des visions colorées, que j'explore via des
				expérimentations formelles et matérielles, intégrant parfois des matériaux biosourcés dans mes peintures. Mon univers oscille entre expressionnisme
				abstrait et illustrations surréalistes oniriques, offrant une interprétation unique de la réalité.
			</p>
